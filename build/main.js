// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":33175}
"use strict";
(() => {
...
var $author$project$Main$displayClass2 = function (list) {
	return A2($elm$core$List$map, $elm$html$Html$Attributes$class, list);
};
var $author$project$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		$author$project$Main$displayClass2(
			_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('font:30'),
						$elm$html$Html$Attributes$class('font:heavy'),
						$elm$html$Html$Attributes$class('color:#ffffff'),
						$elm$html$Html$Attributes$class('background-color:#000000')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('font:50'),
						$elm$html$Html$Attributes$class('font:heavy'),
